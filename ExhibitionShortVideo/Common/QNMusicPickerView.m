...
- (nonnull UITableViewCell *)tableView:(nonnull UITableView *)tableView cellForRowAtIndexPath:(nonnull NSIndexPath *)indexPath {
    ...
    if (indexPath.row == self.selectRow) {
        cell.textLabel.textColor = [UIColor colorWithRed:0.8 green:0.2 blue:0.3 alpha:1];
        cell.detailTextLabel.textColor = [UIColor colorWithRed:0.8 green:0.2 blue:0.3 alpha:1];
    } else {
