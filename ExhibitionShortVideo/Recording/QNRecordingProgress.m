...
@property (nonatomic, readwrite) EnumProgressStyle style;
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _style = enumProgressStyleNormal;
        [self initalize];
    }
    return self;
}
...
- (void)setLastProgressToStyle:(EnumProgressStyle)style {
    UIView *lastProgressView = [_progressViewArray lastObject];
    if (!lastProgressView) {
        return;
    }
